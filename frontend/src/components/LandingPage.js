            ...
            <section id="login" className="login-section">
                <div className="section-container">
                    ...
                    <div className="role-cards">
                        ...
                        {/* Events Card */}
                        <div
                            className="role-card events-card"
                            onClick={() => navigate('/events')}
                        >
                            <div className="role-icon events-icon" style={{ background: 'rgba(236, 72, 153, 0.1)', color: '#ec4899' }}>
                                <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                            ...
                            <h3 className="role-title">Events</h3>
                            <p className="role-description">
                                Register for campus events or host session. Use face recognition to mark attendance for participants instantly.
                            </p>
                            <span className="role-cta">
                                Open Events Portal
                                <span>→</span>
