...
// Use localhost for ADB Reverse (Wired connectivity)
...
// EVENTS
// --------------------------------------------------
export const registerEventParticipant = (formData) => {
  return api.post('/api/event/register', formData, {
    headers: { 'Content-Type': 'multipart/form-data' }
  });
};

export const recognizeEventParticipant = (formData) => {
  return api.post('/api/event/recognize', formData, {
    headers: { 'Content-Type': 'multipart/form-data' }
  });
};
